 ...
 */
function iar_post_cloner_is_enabled( string $post_type ): bool {
 ...
 */
function iar_post_cloner_row_action( array $actions, WP_Post $post ): array {
 ...
 * Handle clone action.
 */
function iar_post_cloner_handle_clone(): void {
 ...
 * @return int|WP_Error
 */
function iar_post_cloner_clone_post( WP_Post $post ) {
	$new_post_args = [
 ...
 */
function iar_post_cloner_clone_taxonomies( int $original_id, int $new_id, string $post_type ): void {
 ...
 */
function iar_post_cloner_clone_meta( int $original_id, int $new_id ): void {
